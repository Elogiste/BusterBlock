...
films_test = [
    Film(
        ...
        genre="Action",
        résumé="Un soldat tente de survivre dans un monde post-apocalyptique.",
    ...
    Film(
        ...
        genre="Romance",
        résumé="Deux inconnus se rencontrent dans un chalet isolé.",
    ...
    Film(
        ...
        genre="Thriller",
        résumé="Un détective découvre un secret de famille bouleversant.",
    ...
    Film(
        ...
        résumé="Une mère célibataire apprend à rire à nouveau.",
    ...
    Film(
        ...
        résumé="Un équipage spatial se perd dans une galaxie lointaine.",
    ...
    Film(
        ...
        titre="Sous la Pluie",
        genre="Drame",
        résumé="Un musicien lutte contre sa dépendance et son passé.",
        nbr_exemplaires_disponible=0
    ),
    Film(
        id=7,
        ...
        genre="Horreur",
        résumé="Des chats mutants attaquent une petite ville.",
    ...
    Film(
        ...
        genre="Science-fiction",
        résumé="Un programmeur est piégé dans son propre jeu.",
    ...
    Film(
        ...
        genre="Comédie",
        résumé="Un chef maladroit essaie de sauver son restaurant.",
    ...
    Film(
        ...
        genre="Fantastique",
        résumé="Une jeune femme voyage à travers les époques.",
        nbr_exemplaires_disponible=0
    ),
]
